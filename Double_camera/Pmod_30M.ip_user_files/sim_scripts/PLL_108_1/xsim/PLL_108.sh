...
#
# Generated by Vivado on Mon Sep 10 15:24:31 +0800 2018
...
# Script info
echo -e "PLL_108.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL_108 xil_defaultlib.PLL_108 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim PLL_108 -key {Behavioral:sim_1:Functional:PLL_108} -tclbatch cmd.tcl -log simulate.log
}
