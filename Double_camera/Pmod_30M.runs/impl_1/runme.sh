...
HD_PWD='C:/Users/84646/Desktop/double_camera/Pmod_30M.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PIC_LAY.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PIC_LAY.tcl -notrace
