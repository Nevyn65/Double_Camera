...
HD_PWD='C:/Users/84646/Desktop/double_camera/Pmod_30M.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PIC_LAY.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PIC_LAY.tcl
