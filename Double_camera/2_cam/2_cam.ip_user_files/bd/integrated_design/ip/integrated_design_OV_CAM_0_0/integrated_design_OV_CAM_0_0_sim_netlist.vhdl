...
--               /home/wyn/src/pynq_stereo/integration/integration.srcs/sources_1/bd/integrated_design/ip/integrated_design_OV_CAM_0_0/integrated_design_OV_CAM_0_0_sim_netlist.vhdl
...
entity integrated_design_OV_CAM_0_0_OV5640_Config is
  port (
  ...
  attribute ORIG_REF_NAME of integrated_design_OV_CAM_0_0_OV5640_Config : entity is "OV5640_Config";
end integrated_design_OV_CAM_0_0_OV5640_Config;

architecture STRUCTURE of integrated_design_OV_CAM_0_0_OV5640_Config is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity integrated_design_OV_CAM_0_0_OV_CAM_CLK_Divider is
  port (
    CLK : out STD_LOGIC;
    clock : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of integrated_design_OV_CAM_0_0_OV_CAM_CLK_Divider : entity is "OV_CAM_CLK_Divider";
end integrated_design_OV_CAM_0_0_OV_CAM_CLK_Divider;

architecture STRUCTURE of integrated_design_OV_CAM_0_0_OV_CAM_CLK_Divider is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity integrated_design_OV_CAM_0_0_OV_CAM_Capture is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of integrated_design_OV_CAM_0_0_OV_CAM_Capture : entity is "OV_CAM_Capture";
end integrated_design_OV_CAM_0_0_OV_CAM_Capture;

architecture STRUCTURE of integrated_design_OV_CAM_0_0_OV_CAM_Capture is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity integrated_design_OV_CAM_0_0_OV_CAM_SCCB is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of integrated_design_OV_CAM_0_0_OV_CAM_SCCB : entity is "OV_CAM_SCCB";
end integrated_design_OV_CAM_0_0_OV_CAM_SCCB;

architecture STRUCTURE of integrated_design_OV_CAM_0_0_OV_CAM_SCCB is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity integrated_design_OV_CAM_0_0_OV_CAM_Controller is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of integrated_design_OV_CAM_0_0_OV_CAM_Controller : entity is "OV_CAM_Controller";
end integrated_design_OV_CAM_0_0_OV_CAM_Controller;

architecture STRUCTURE of integrated_design_OV_CAM_0_0_OV_CAM_Controller is
...
\cam5640.config_rom\: entity work.integrated_design_OV_CAM_0_0_OV5640_Config
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity integrated_design_OV_CAM_0_0_OV_CAM is
  port (
    pclk_out : out STD_LOGIC;
    done : out STD_LOGIC;
    out0 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of integrated_design_OV_CAM_0_0_OV_CAM : entity is "OV_CAM";
end integrated_design_OV_CAM_0_0_OV_CAM;

architecture STRUCTURE of integrated_design_OV_CAM_0_0_OV_CAM is
...
begin
  out0 <= \^out0\;
capturer: entity work.integrated_design_OV_CAM_0_0_OV_CAM_Capture
     port map (
...
controller: entity work.integrated_design_OV_CAM_0_0_OV_CAM_Controller
     port map (
      CLK => sccb_clk,
...
divider: entity work.integrated_design_OV_CAM_0_0_OV_CAM_CLK_Divider
     port map (
      CLK => sccb_clk,
      clock => clock
    );
sccb: entity work.integrated_design_OV_CAM_0_0_OV_CAM_SCCB
     port map (
      CLK => sccb_clk,
      Q(3) => sccb_n_0,
      Q(2) => sccb_n_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity integrated_design_OV_CAM_0_0 is
  port (
    clock : in STD_LOGIC;
    reset : in STD_LOGIC;
    start : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of integrated_design_OV_CAM_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of integrated_design_OV_CAM_0_0 : entity is "integrated_design_OV_CAM_0_0,OV_CAM,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of integrated_design_OV_CAM_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of integrated_design_OV_CAM_0_0 : entity is "OV_CAM,Vivado 2016.3";
end integrated_design_OV_CAM_0_0;

architecture STRUCTURE of integrated_design_OV_CAM_0_0 is
...
inst: entity work.integrated_design_OV_CAM_0_0_OV_CAM
     port map (
