...
HD_PWD='C:/Users/84646/Desktop/Ne/double_camera/2_cam/2_cam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log integrated_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source integrated_design.tcl
