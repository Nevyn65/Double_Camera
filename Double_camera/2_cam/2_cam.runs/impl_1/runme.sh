...
HD_PWD='C:/Users/84646/Desktop/Ne/double_camera/2_cam/2_cam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log integrated_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source integrated_design.tcl -notrace
